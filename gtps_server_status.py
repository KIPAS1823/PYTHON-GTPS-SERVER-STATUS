...
async def s(ctx):
	if ctx.author.id == YOUR ACCOUNT ID:
		...
		embed.add_field(name='Total Players Create', value=listplayerss)
		embed.add_field(name='Total Worlds Create', value=listworldss)
		...
		while True:
			...
			newembed.add_field(name='Total Worlds Create', value=listworld)
